          ...
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <Reveal delay={0.24}>
                <div className="hero-actions">
                  <ButtonLink to="/projects">Explore technical work</ButtonLink>
            ...
            <Reveal delay={0.15} className="hero-visual">
              <div className="hero-identity-stage">
                <div className="hero-ai-ring" aria-hidden>
                  <span />
                  <span />
                  <span />
                </div>
      ...
      <Section className="section-tight-bottom">
        <Container>
          <RevealStagger className="stats-grid">
            {HERO_STATS.map((stat) => (
              <motion.div key={stat.label} className="stat-card" variants={itemFade}>
        ...
        <Container>
          <Reveal>
            <div className="section-head">
              <div>
                <div className="section-kicker">Selected builds</div>
                <h2 className="section-title">Highlighted technical work</h2>
              </div>
              ...
              <Reveal key={p.slug} delay={i * 0.06}>
                <GlassCard className="project-card">
                  ...
                  <div className="project-card-body">
                    <span className="project-card-label">Featured system</span>
                    <h3>{p.title}</h3>
                    <p>{p.summary}</p>
                    {p.repoUrl ? (
